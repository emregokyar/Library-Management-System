...
public class EntrancePanel extends JPanel {
    ...
    private final JTextField userPass;
    private final JButton submit;
    private final JButton adminEntry;
    ...
    public EntrancePanel() {
        ...
        adminEntry = new JButton("ADMIN");
        adminEntry.setPreferredSize(new Dimension(117, 20));
        this.add(adminEntry);
        this.add(Box.createHorizontalStrut(5));

        signup = new JButton("SIGN UP");
        signup.setPreferredSize(new Dimension(117, 20));
        this.add(signup);
    }
